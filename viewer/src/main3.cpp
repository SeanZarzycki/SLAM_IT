...
main (int argc, char** argv)
{
  ...
  {
    file_name = (argv[pcl::console::find_argument (argc, argv, "-f") + 1]);
  }
  ...
  pcl::io::loadPCDFile (file_name, *basic_cloud_ptr);
  pcl::io::loadPCDFile (file_name, *point_cloud_ptr);
