...
//                    new CompareSizesByArea());
            Size largestJpeg = new Size(1024, 768);
            ...
            switch (format) {
                case ImageFormat.JPEG: {
                    ...
                    try {
                        ...
                        jo.put("imageBase64", encodedString);
                        jo.put("timestamp", timestamp);
                        String jsonString = jo.toString();
                        jsonString = jsonString.replace("\\n", "");
                        jsonString = jsonString.replace("\\", "");
                        String urlString = "http://10.0.0.36:8080/upload";
                        ...
                        if (jsonString != null) {
                            ...
                            urlConnection.setRequestProperty("Content-Length", Integer.toString(jsonString.length()));
                        ...
                        if (result == HttpsURLConnection.HTTP_OK) {
                            in = urlConnection.getInputStream(); // to get result
                        }
