...
struct FrameHessian
{
    ...
    void makeImages(float* color, float* ri, float* gi, float* bi, CalibHessian* HCalib);
...
struct PointHessian
{
	...
	float rc[MAX_RES_PER_POINT];
	float gc[MAX_RES_PER_POINT];
	float bc[MAX_RES_PER_POINT];
